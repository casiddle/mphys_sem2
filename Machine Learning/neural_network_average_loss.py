...
ax2.set_xlabel('Simulation Beam Energy (GeV)')
ax2.set_ylabel('Predicted Beam Energy (GeV)')
ax2.legend()
...
ax3.set_xlabel(r'Simulation Emittance ($\mu m$)')
ax3.set_ylabel(r'Predicted Emittance ($\mu m$)')
ax3.legend()
...
ax5.set_xlabel('Actual Beam Energy (GeV)')
ax5.set_ylim(-3,3)
...
ax6.set_xlabel(r'Actual Emittance ($\mu m$)')
ax6.set_ylim(-3,3)
