...
hidden_array=np.array([10,100,200,300,500])
...
plt.plot(hidden_array, emittance_loss_array, label='Emittance Loss', color='b', linestyle='-', marker='o')
plt.plot(hidden_array, energy_loss_array, label='Energy Loss', color='g', linestyle='--', marker='x')
plt.plot(hidden_array, spread_loss_array, label='Spread Loss', color='r', linestyle='-.', marker='s')
