...
data_no_array=np.array([50,100,200,300,500,600])
...
# Plotting the three loss arrays with appropriate titles, labels, and legends
plt.plot(data_no_array, emittance_loss_array, label='Emittance Loss', color='b', linestyle='-', marker='o')
plt.plot(data_no_array, energy_loss_array, label='Energy Loss', color='g', linestyle='--', marker='x')
plt.plot(data_no_array, spread_loss_array, label='Spread Loss', color='r', linestyle='-.', marker='s')

# Adding title and labels
plt.title('Loss Curves for Different Parameters', fontsize=14)
plt.xlabel('No. Data points', fontsize=12)
